		...
		<form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data" novalidate>
			...
			<div class="mb-3">
				...
				<input type="url" class="form-control @error('url_image') is-invalid @enderror" id="url_image" name="url_image"
					value="{{ old('url_image', 'https://picsum.photos/id/' . rand(100, 800) . '/500/350') }}">
				@error('url_image')
					<div class="invalid-feedback">
						{{ $message }}
					</div>
			...
			<div class="mb-3 d-flex justify-content-center">
				<button class="btn btn-success fs-4"><i class="bi bi-clipboard-check"></i> Create</button>
			    <a href="{{ route('admin.projects.index') }}" class="btn btn-danger fs-4 ms-4"><i class="bi bi-backspace"></i>
				Cancel</a>
			</div>
